...
| `governance/00d_HARA_Worksheet.md` | Hazardous Event, S/E/C, ASIL Candidate 및 Safety Goal 정의 |
| `01_Requirements.md` | 시스템 요구사항 정의 (`What`) 및 HARA 추적성 |
| `02_Concept_design.md` | 시스템 구조, ECU 경계 및 안전 개념 정의 |
| `03_Function_definition.md` | 기능별 입력, 처리, 출력 및 Fault 동작 정의 |
| `0301_SysFuncAnalysis.md` | 시스템 기능 분해 및 기능 간 관계 분석 |
| `0302_NWflowDef.md` | 입력 ECU와 출력 ECU 사이의 네트워크 데이터 흐름 정의 |
| `0303_Communication_Specification.md` | CAN ID, DLC, Signal, 주기 및 진단 조건 정의 |
| `0304_System_Variables.md` | 시스템 변수, 자료형, 범위, 초기값 및 사용 SWC 정의 |
| `04_SW_Implementation.md` | SWC, RTE, Runnable, Task Mapping 및 IoHwAb 구현 명세 |
