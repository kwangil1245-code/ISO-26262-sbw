...
| `0302_Network_Flow_Definition.md` | SWR-COM, SWR-DIAG, SWR-MON | ECU 간 데이터 흐름과 송수신 순서 |
| `0303_Communication_Specification.md` | SWR-COM, SWR-DIAG, SWR-MON | CAN ID, DLC, 신호, 자료형, 범위 및 송신 주기 |
| `0304_System_Variables.md` | SWR-DIAG, SWR-WDG, SWR-SAFE, SWR-CTRL | 상태값, Fault Flag, 임계값, Counter 및 초기값 |
| `04_SW_Design_Implementation.md` | 전체 `SWR-*` | RTE API, Task Mapping, 내부 로직, PWM 계산식, IoHwAb 및 코드 |
| Test Specification | 전체 `SWR-*` | 입력 조건, 절차, 기대 결과 및 합격 기준 |

## 7. 상세정보 관리 기준

| 상세정보 | 관리 문서 |
|---|---|
| CAN ID, DLC, Signal, 자료형, 범위, 10 ms 송신 주기 | `0303_Communication_Specification.md` |
| Alive Counter 증가 방식과 Timeout 판정 횟수 | `0303_Communication_Specification.md`, `0304_System_Variables.md` |
| WdgM 상태값, Checkpoint 및 Supervised Entity | `0301_SW_Architecture_Design.md`, `0304_System_Variables.md` |
| 정상 복귀 확인 횟수와 상태 전이 조건 | `0304_System_Variables.md`, `04_SW_Design_Implementation.md` |
| 방향 판정 임계값과 PWM 계산식 | `0304_System_Variables.md`, `04_SW_Design_Implementation.md` |
| SWC, Port, Runnable, RTE 및 Task Mapping | `0301_SW_Architecture_Design.md`, `04_SW_Design_Implementation.md` |
| IoHwAb 채널과 실제 핀 연결 | `04_SW_Design_Implementation.md` |
